...
description: Use when an agent is about to say work is done, fixed, passing, ready to merge, or ready to ship. Apply this skill whenever a completion claim needs fresh evidence from commands, tests, runtime checks, or direct inspection instead of assumption.
---
