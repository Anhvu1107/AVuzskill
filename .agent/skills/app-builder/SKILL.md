---
name: app-builder
description: Use when a request is really about building or extending an application, not just changing one isolated file. Apply this skill for turning product asks into app shape, stack choices, delivery sequence, and the right supporting skills or templates.
---
